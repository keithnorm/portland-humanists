...
const perks = [
  ...
  {
    label: 'Live music',
    sub: 'First Sundays of the month',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#upcoming-events" className="bg-white text-[var(--hgp-primary)] px-6 py-3 rounded-lg font-semibold hover:bg-[var(--hgp-surface-alt)] transition-colors [text-shadow:none]">
                See Upcoming Programs
              </a>
              <a href="/join" className="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-[var(--hgp-primary)] transition-colors [text-shadow:none]">
                Join Our Community
              </a>
            </div>
          </div>
        ...
        <section className="py-16 bg-neutral-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-end mb-12">
              ...
              <a href="/events/past" className="text-[var(--hgp-primary)] font-semibold flex items-center gap-2">
                View All
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
